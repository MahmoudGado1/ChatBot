...
const Chat2 = () => {
  const [messages, setMessages] = useState([
    { text: "Hello! How can I assist you with your purchase today?", sender: "bot" },
  ]);
  ...
  const getBotResponse = (message) => {
    ...
    if (lowerCaseMessage.includes("recommend")) return "I can suggest some great products for you!";
    if (lowerCaseMessage.includes("track order")) return "Sure! Please provide your order ID.";
  ...
  return (
    <section className="relative h-[100vh] flex items-center mt-20 justify-center bg-gray-100">
      <div className="bg-white shadow-lg rounded-lg p-6 w-[500px]">
        <h1 className="text-2xl font-bold mb-4 text-center">Sales Assistant Chatbot</h1>
